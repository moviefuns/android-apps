...
## Part of the BARBURAS app suite

| App | Description | Status |
|-----|-------------|--------|
| [Nóta](../nota) | Nextcloud Notes client | ✅ Published |
| **Merk** | Nextcloud Bookmarks client | ✅ Published |
| Blik | Screenshot manager with Nextcloud WebDAV | 🔜 Soon |
