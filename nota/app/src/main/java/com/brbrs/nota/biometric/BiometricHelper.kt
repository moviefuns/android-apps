package com.brbrs.nota.biometric
...
class BiometricHelper @Inject constructor(
     ...
     * [activity] must be a FragmentActivity (Compose's ComponentActivity qualifies).
     * [onResult] is called on the main thread.
     */
    fun authenticate(
        ...
        val callback = object : BiometricPrompt.AuthenticationCallback() {
            ...
            override fun onAuthenticationFailed() {
                // Finger not recognized — the system UI shows an error automatically
                // Don't call onResult here; let user retry
            }
        }
